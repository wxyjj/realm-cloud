...
import com.example.gateway.rest.RestAuthenticationEntryPoint;
import com.example.gateway.rest.RestfulAccessDeniedHandler;
...
public class ResourceServerConfig {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        http.authorizeExchange()
                .pathMatchers(ArrayUtil.toArray(ignoreUrlProperties.getUrls(), String.class)).permitAll()//白名单配置
