...
import com.example.netty.component.SpringContextUtils;
...
public class NettyServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    static {
        ...
        nettyProperties = SpringContextUtils.getBean(NettyProperties.class);
    }
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        String websocketUrl = "ws://127.0.0.0:" + nettyProperties.getPort() + nettyProperties.getPath();
