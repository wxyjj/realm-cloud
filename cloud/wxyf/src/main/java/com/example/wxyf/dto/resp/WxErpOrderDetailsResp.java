 ...
 */
@Data
@ApiModel(value = "订单详情查询返回体")
public class WxErpOrderDetailsResp implements Serializable {
    ...
    private List<WxErpOrderItemsResp> goodsinfo;
    @ApiModelProperty(value = "OMS订单处方信息返回体")
    private List<WxErpOrderPrescriptionResp> prescriptionform;
}
