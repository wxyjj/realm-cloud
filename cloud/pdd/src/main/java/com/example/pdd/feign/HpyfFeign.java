...
import com.example.pdd.fallback.HpyfFallBack;
 ...
 * @Version 1.0
 */
@FeignClient(value = "hpyf", fallback = HpyfFallBack.class)
public interface HpyfFeign {
     ...
     * @return Object
     */
    @PostMapping(value = "/oms/saveOrderMessage")
     ...
     * @return Object
     */
    @PostMapping(value = "/oms/goodsCheckCode")
