...
@Data
@Entity
@Table(name = "hp_order_details")
@org.hibernate.annotations.Table(appliesTo = "hp_order_details", comment = "和平订单详情")
public class HpOrderDetails implements Serializable {
